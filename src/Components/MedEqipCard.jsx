...
const MedEquipCard =(props)=>{
    return(
        ...
        <div className="col-8 m-0 mb-1" style={{backgroundColor:'#BFE9FB',marginBottom:'20px',width:'100%',borderRadius:'10px'}}>
            <p style={{textAlign:'left',fontSize:'14px',textAlign:'center',margin:0}}>
            <span style={{fontWeight:'bold'}}>{props.item?.location?.locationName}</span><br/>
            <span>{props.item?.location?.address}</span>
            </p>
            <p>        
